...
**April 2017** — MIT math professor Andrew V. Sutherland [breaks the record](http://220,000 cores and counting: MIT math professor breaks record for largest ever Compute Engine job) for the largest ever Compute Engine cluster with 220,000 cores on [Preemptible VMs](https://cloud.google.com/preemptible-vms/).
